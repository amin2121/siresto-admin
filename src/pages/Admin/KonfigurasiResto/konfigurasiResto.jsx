			    	...
			    	<div className="py-4">
			      	...
			      	<div className="grid grid-cols-8 gap-4 mb-4">
			      		...
			      		<div className="relative col-span-4">
			      			<Input type="file" name="logo" control={control} rules={{ required: false }} className="py-2" error={errors.nama_produk ? true : false} onChange={e => convertImageToBase64(e)}/>
			      			<input type="hidden" {...register('logo_lama')}/>
			      			{errors?.logo && <span className="text-red-400 block mt-2">Logo Tidak Boleh Kosong</span>}
			      		</div>
							</div>
