    ...
    return (
        <div className="px-6">
            ...
            <div className="grid gap-6 md:grid-cols-4 grid-cols-1 grid-rows-1">
                ...
                <CardCount title="Jumlah Produk" value={data.jumlah_produk} icon={<MdLoyalty size={20} className="text-lg text-blue-500"/>} color="blue"/>
                <CardCount title="Pendapatan Hari Ini" value={data.pendapatan_hari_ini} icon={<FiShoppingCart size={20} className="text-lg text-blue-500"/>} color="blue"/>
                ...
                <div className="md:basis-4/12 flex-1 bg-white items-center rounded-3xl border border-gray-300">
                    ...
                    <div className="p-5 pt-3">
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody>
                                {isSuccess ? data.produk_populer.map((item, index) => (
                                    <tr className="border-b border-gray-200" key={index}>
                                        <td className="py-2">
                                           <img src={baseUrl + item.gambar} alt="image" className="w-10 h-10 object-cover rounded-md"/> 
                                        </td>
