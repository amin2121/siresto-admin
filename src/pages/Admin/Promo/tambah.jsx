...
const Tambah = () => {
	...
	const mutation = useMutation(async (data) => {
  	...
  	formData.append('promo', data.nominal_promo)
		...
		const config = {     
		    headers: { contentType: 'multipart/form-data', Authorization: `Bearer ${user.token}` }
		}
  ...
  return (
        <>
        	<HeaderContent linkBack="/promo" title="Tambah Promo" breadcrumbs={breadcrumbs}></HeaderContent>
			    	...
			    	<form onSubmit={handleSubmit(tambahData)}>
			      	...
			      	<div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
			      		...
			      		<div className="relative col-span-12 md:col-span-4">
			      			<Input type="text" placeholder="Judul Promo" name="judul_promo" control={control} rules={{required: true}} error={errors.judul_promo ? true : false}/>
				        ...
				        <div className="relative col-span-12 md:col-span-4">
			      		...
			      		<div className="relative col-span-12 md:col-span-4">
			      			<Input type="date" placeholder="Tanggal Awal Promo" className="py-2" name="tanggal_awal_promo" control={control} rules={{required: true}} error={errors.tanggal_awal_promo ? true : false}/>
			      		...
			      		<div className="relative col-span-12 md:col-span-4">
				  			<InputGroup icon="Hari" directionIcon="right" type="number" placeholder="Periode Promo" name="periode_promo" control={control} rules={{required: true}} error={errors.periode_promo ? true : false}/>
			      			{errors?.periode_promo && <MessageError>Periode Promo Tidak Boleh Kosong</MessageError>}
			      		</div>
							</div>
		    				...
		    				<div className="relative col-span-12 md:col-span-4 flex">
					  			...
					  			<div className="form-control flex-1 mr-4">
									  <label className="label cursor-pointer">
									    ...
									    <input type="radio" name="status_promo" {...register('status_promo')} value="nominal" className="radio radio-secondary" checked />
									  </label>
									</div>
					    ...
					    <div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
			      		...
			      		<div className="relative col-span-12 md:col-span-4">
				  			<Textarea placeholder="Deskripsi Promo" name="deskripsi_promo" control={control} rules={{required: true}} error={errors.deskripsi_promo ? true : false} className="w-full"></Textarea>
