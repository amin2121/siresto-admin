...
const Edit = () => {
	...
	useEffect(() => {
		...
		setValue('id_kategori_bisnis', {label: data.kategori_bisnis.kategori_bisnis, value: data.id_kategori_bisnis})
        ...
        <>
			...
			<div className="bg-white h-max px-6 rounded-lg mt-0 md:mt-4">
					...
					<div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
			      		...
			      		<div className="relative col-span-12 md:col-span-4">
			      			<Input type="text" placeholder="Nomor Telepon" name="nomor_telepon" control={control} required error={errors.nomor_telepon ? true : false}/>
