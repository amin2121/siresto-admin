...
const Resto = () => {
  ...
  return (
    <>
            ...
            {isFetching ? (
              ...
              data?.map((obj, key) => (
                <tr className="bg-white border-b border-blue-200" key={key}>
                  <td className="py-4 px-6 text-sm text-center">{++key}</td>
                  ...
                  <td className="py-4 px-6 text-center">
                    <div className="md:space-x-3 space-x-1">
                      ...
                      >
                        <label htmlFor="modal-ubah-status">
                          <ButtonIconOutline
                            onClick={() => checkedStatusResto(obj)}
                          >
                      ...
                      <div
                        className="tooltip tooltip-bottom"
                        data-tip="Edit Lisensi & Tambah Masa Trial Resto"
                      >
                        <Link to="/resto/edit/lisensi" state={obj}>
                          <ButtonIconOutline>
                            <FiKey size="16" />
                          </ButtonIconOutline>
                        </Link>
      ...
      <Modal
        id="modal-ubah-status"
        showButtonConfirm={true}
        typeButtonConfirm="submit"
        titleButtonConfirm="Simpan"
        showButtonClose={true}
        titleModal="Ubah Status Resto"
        submitForm={handleSubmit(changeStatus)}
      >
