...
const KategoriProduk = () => {
  ...
  const fetchData = async () => {
    ...
    const response = await axios.get(
      `kategori-produk?s=${keyword}&limit=${limit}&sort=DESC&page=${page}`
    );
                  ...
                  <td className="py-4 px-6">
                    <div className="md:space-x-3 space-x-1 text-center">
                      <div
                        ...
                        data-tip="Edit Kategori Produk"
                      >
                        <Link to="/kategori-produk/edit" state={obj}>
                          <ButtonIconOutline>
                            <FiEdit3 size="16" />
                          </ButtonIconOutline>
                        </Link>
                      ...
                      <div
                        className="tooltip tooltip-bottom"
                        data-tip="Hapus Kategori Produk"
                      >
                        {/* <ButtonIconOutline
