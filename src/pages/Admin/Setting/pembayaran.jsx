        ...
        <>
        	...
        	<div className="bg-white h-max px-6 rounded-lg h-96 mt-4 grid grid-cols-8 gap-4 relative" key={1}>
        		...
        		<div className="md:col-span-3 col-span-12 shadow-lg shadow-blue-100 rounded grid grid-cols-2 gap-4 px-6 py-10 text-sm rounded">
        			...
        			<div className={`setting__choose border-2 border-gray-300 p-2 h-32 flex flex-col items-center justify-center space-y-2 rounded ${setting == 'alur_pembayaran' ? 'active' : ''} `} onClick={() => setSetting('alur_pembayaran')}>
        				<BiGitBranch size={40} />
        				<p>Alur Pembayaran</p>
        			</div>
        		</div>
        		...
        		<div className="md:col-span-5 col-span-12 shadow-lg shadow-blue-100 rounded px-6 py-10 rounded">
    				<form onSubmit={handleSubmit(ubahSetting)}>
	        			<div className={`${setting == 'pajak_service' ? 'block' : 'hidden'}`}>
		        			...
		        			<div className="setting__content space-y-5">
			        			<div className="setting__item flex justify-between items-center">
			        				<div>
			        					<h3 className="text-sm font-semibold mb-1">Penggunaan Pajak</h3>
			        					<p className="text-xs text-slate-400">Hidupkan jika ingin menambahkan pajak dalam setiap transaksi penjualan </p>
			        					<div className="form-group flex items-center mt-2">
			        						<InputGroup type="text" id="input-pajak" directionIcon="right" name="pajak" icon='%' className="p-1 input-sm !w-24" control={control} disabled={dataInput.status_pajak == 0}/>
			        					</div>
			        				</div>
			        				<div>
			        			...
			        			<div className="setting__item flex justify-between items-center">
			        				<div>
			        					<h3 className="text-sm font-semibold mb-1">Penggunaan Service Charge</h3>
			        					<p className="text-xs text-slate-400">Hidupkan jika ingin menambahkan service charge dalam setiap transaksi penjualan </p>
			        					<div className="form-group flex items-center mt-2">
			        						<InputGroupCurrency type="number" id="input-service-charge" directionIcon="left" name="charge_service" icon='IDR' placeholder="Jumlah Uang" control={control} className="p-1 input-sm !w-40" disabled={dataInput.status_charge_service == 0}/>
			        					</div>
			        				</div>
			        				<div>
	        			...
	        			<div className={`${setting == 'alur_pembayaran' ? 'block' : 'hidden'}`}>
	        				<h1 className="text-md font-bold mb-4">Alur Pembayaran</h1>
		        			<div className="setting__content space-y-5">
			        			<div className="setting__item flex justify-between items-center">
			        				<div>
			        					<h3 className="text-sm font-semibold mb-1">Alur Pembayaran Konsumen</h3>
			        					<p className="text-xs text-slate-400">Alur pembayaran konsumen bisa diubah dari langsung bayar atau bayar nanti </p>
			        					<div className="form-group flex items-center mt-2 space-x-4">
				        					...
				        					<div className="form-control">
											  <label className="label cursor-pointer space-x-4">
			        							...
			        							<input type="radio" name="alur_pembayaran_konsumen" value="bayar_langsung" className="radio radio-secondary" {...register('alur_pembayaran_konsumen')}/>
											  </label>
											</div>
											...
											<div className="form-control">
											  <label className="label cursor-pointer space-x-4">
			        							...
			        							<input type="radio" name="alur_pembayaran_konsumen" value="bayar_nanti" className="radio radio-secondary" {...register('alur_pembayaran_konsumen')}/>
											  </label>
											</div>
