...
import { LaporanStokOpname } from "./Cetak/StokOpname";
...
const StokOpname = () => {
  ...
  const fetchOrder = useCallback(async () => {
    ...
    const response = await axios.get(
      `laporan/stok-opname?tanggal-awal=${tanggalAwalFormat}&tanggal-akhir=${tanggalAkhirFormat}`
    );
