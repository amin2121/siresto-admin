...
const Pendapatan = () => {
	...
	const fetchOrder = async () => {
		...
		const response = await axios.get(`laporan/laporan-pendapatan?tanggal-awal=${tanggalAwalFormat}&tanggal-akhir=${tanggalAkhirFormat}`)
    ...
    return (
        <>
		    ...
		    <div className="py-4">
        	 	<LaporanPendapatan ref={componentRef} tanggalAwal={tanggalAwal} tanggalAkhir={tanggalAkhir} data={data}/>
		    </div>
