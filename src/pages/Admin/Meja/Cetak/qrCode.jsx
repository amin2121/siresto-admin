          ...
          <div className="flex justify-center items-center mb-4">
            <QRCode
              ...
              value={
                ...
                `home?source=qrcode&branch=${slug}&meja=${noMeja}`
              }
            />
          </div>
          <div>
            <p className="text-[8px]">
              Scan QR Code dengan Smartphone anda, setelah itu akses link dari
              hasil QR Code Tersebut
            </p>
          </div>
        </div>
      </div>
