...
const Edit = () => {
  ...
  useEffect(() => {
    ...
    setValue("id_kategori_produk", {
      label: data.kategori_produk.kategori_produk,
        ...
        <form onSubmit={handleSubmit(editData)}>
          ...
          <div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
            ...
            <div className="relative col-span-12 md:col-span-4">
              <Input
                ...
                control={control}
                rules={{ required: true }}
                error={errors.nama_produk ? true : false}
              />
              {errors?.nama_produk && (
                <MessageError>Nama Produk Tidak Boleh Kosong</MessageError>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
            ...
            <div className="relative col-span-12 md:col-span-4">
              <Input
                ...
                control={control}
                rules={{ required: true }}
                error={errors.nomor_sku ? true : false}
              />
              {errors?.nomor_sku && (
                <MessageError>Nomor SKU Tidak Boleh Kosong</MessageError>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
            ...
            <div className="relative col-span-12 md:col-span-4">
              <InputCurrency
                ...
                name="harga_awal"
                control={control}
                error={errors.harga_awal ? true : false}
              />
              {errors?.harga_awal && (
                <MessageError>Harga Awal Tidak Boleh Kosong</MessageError>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-8 gap-1 md:gap-4 mb-4">
            ...
            <div className="relative col-span-12 md:col-span-4">
              ...
              />
              {errors?.harga_jual && (
                <MessageError>Harga Jual Tidak Boleh Kosong</MessageError>
              )}
            </div>
          </div>
          ...
          <div
            className={`grid grid-cols-8 gap-1 md:gap-4 mb-4 ${
              statusDiskon == "0" && "hidden"
            } duration-200`}
            id="content-harga-diskon"
          >
            <label className="label col-span-12 md:col-span-2">
